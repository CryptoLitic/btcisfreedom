...
module.exports = async (req, res) => {
  try{
    ...
    res.status(200).json({ alt_fng: altValue, funding_score: fundingScore, vol_score: volScore, ai_sentiment: ai, median, label });
  }catch(e){
    res.status(200).json({ alt_fng: 50, funding_score: 50, vol_score: 50, ai_sentiment: 50, median: 50, label: 'Neutral' });
  }
}
